...
(
    number INT NOT NULL PRIMARY KEY CHECK (number >= 1 AND number <= 1500),
...
(
    ...
    name VARCHAR(64),
    patronymic VARCHAR(64),
    heihgt INT CHECK (heihgt >= 150 AND heihgt <=200),
    weight INT CHECK (weight >= 30 AND weight <= 200),
    room_number INT CHECK (room_number >= 1 AND room_number <= 1500),
